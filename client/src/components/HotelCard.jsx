...
const HotelCard = ({room,index}) => {
  return (
    <Link className='rounded-2xl overflow-hidden relative max-w-70 w-full bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)] hover:scale-110 transition-all duration-200' to={'/rooms/' + room._id} key={room._id}>
